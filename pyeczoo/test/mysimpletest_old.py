...
#eczoodbDataUrl = 'https://errorcorrectionzoo.org/dat/eczoodata.json'
#eczoodbRefsDataUrl = 'https://errorcorrectionzoo.org/dat/eczoorefsdata.json'

eczoodbDataUrl = 'file://' + os.path.abspath('../site/_site/dat/eczoodata.json')
eczoodbRefsDataUrl = 'file://' + os.path.abspath('../site/_site/dat/eczoorefsdata.json')
